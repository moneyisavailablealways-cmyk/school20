  ...
  public: {
    Tables: {
      ...
      grading_config: {
        ...
        Relationships: [
          {
            foreignKeyName: "grading_config_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      library_transactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "library_transactions_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      parent_enrollments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "parent_enrollments_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      report_signatures: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "report_signatures_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      student_subject_enrollments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "student_subject_enrollments_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      subject_submissions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "subject_submissions_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      teacher_leave_requests: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "teacher_leave_requests_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      term_configurations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "term_configurations_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
