...
-- This shouldn't be necessary as we handled this in previous migrations, but let's be safe
...
PERFORM public.log_activity(
  'schema_fix',
  'Fixed relationship ambiguity between classes and levels tables',
  auth.uid(),
  jsonb_build_object('action', 'single_foreign_key_constraint_added')
);